...
import { featuredEventsArticle, EventsArticles } from "./data/EventsData.js";
...
export function Events() {
  ...
  const featuredArticle = featuredEventsArticle(isUk);
  const Articles = EventsArticles(isUk);
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="pt-8 pb-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <Link 
            to={`/events/${featuredArticle.id}`}
            className="group"
          >
            <Card 
              className="group overflow-hidden border shadow-lg bg-white hover:shadow-xl transition-transform duration-500 transform hover:scale-[1.02] flex flex-col h-full cursor-pointer"
            >
