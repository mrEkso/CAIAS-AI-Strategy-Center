...
import { cn } from "./utils.js"; // Explicit `.js` for NodeNext compatibility
...
// Extended PayloadItem with all possibly needed properties
type PayloadItem = {
  dataKey?: string;
  name?: string;
...
function isPayloadObject(obj: unknown): obj is { payload?: Record<string, any> } {
  return (
    typeof obj === "object" &&
    obj !== null &&
    "payload" in obj &&
...
function getPayloadConfigFromPayload(config: ChartConfig, payload: unknown, key: string) {
  ...
  const payloadPayload = isPayloadObject(payload) ? payload.payload : undefined;
...
function ChartTooltipContent({
  ...
  nameKey,
  labelKey,
}: Omit<TooltipProps<any, any>, "payload" | "label"> & // Remove default payload and label type
  React.ComponentProps<"div"> & {
    payload?: PayloadItem[];
    hideLabel?: boolean;
  ...
  }, [label, labelFormatter, typedPayload, labelClassName, config, labelKey]);
